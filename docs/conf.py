...
copyright = "2022, Qiskit Algorithms Development Team"  # pylint: disable=redefined-builtin
...
vers = version.split(".")
link_str = f" https://github.com/Qiskit/qiskit-algorithms/blob/stable/{vers[0]}.{vers[1]}/docs/"
