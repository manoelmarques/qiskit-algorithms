...
contributing to Qiskit Algorithms, these are documented below.
...
1. The code follows the _code style_ of this project and successfully
   passes the _unit tests_. Algorithms uses [Pylint](https://www.pylint.org) and
...
2. The documentation has been updated accordingly. In particular, if a
   ...
   *docstring* accordingly.
   ...
   there is a [.pylintdict](./.pylintdict) custom word list file, in the root of the Algorithms repo,
...
Source](https://github.com/Qiskit/qiskit-algorithms#installation)

Note: Algorithms depends on Terra, and has optional dependence on Aer and IBM Q Provider, so
...
```
git blame --ignore-revs-file .git-blame-ignore-revs algorithms/version.py
```
